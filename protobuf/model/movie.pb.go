...
type MovieListByStar struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	List map[string]*MovieList `protobuf:"bytes,1,rep,name=List,proto3" json:"List,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *MovieListByStar) Reset() {
	*x = MovieListByStar{}
	if protoimpl.UnsafeEnabled {
...
func (x *MovieListByStar) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MovieListByStar) ProtoMessage() {}

func (x *MovieListByStar) ProtoReflect() protoreflect.Message {
	mi := &file_movie_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MovieListByStar.ProtoReflect.Descriptor instead.
func (*MovieListByStar) Descriptor() ([]byte, []int) {
	return file_movie_proto_rawDescGZIP(), []int{2}
}

func (x *MovieListByStar) GetList() map[string]*MovieList {
	if x != nil {
		return x.List
	}
	return nil
...
var file_movie_proto_rawDesc = []byte{
	...
	,
...
var file_movie_proto_goTypes = []interface{}{
	...
	(*MovieList)(nil),       // 1: model.MovieList
	(*MovieListByStar)(nil), // 2: model.MovieListByStar
	nil,                     // 3: model.MovieListByStar.ListEntry
}
var file_movie_proto_depIdxs = []int32{
	0, // 0: model.MovieList.movies:type_name -> model.Movie
	3, // 1: model.MovieListByStar.List:type_name -> model.MovieListByStar.ListEntry
	1, // 2: model.MovieListByStar.ListEntry.value:type_name -> model.MovieList
